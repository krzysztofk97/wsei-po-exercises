...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        [DataTestMethod, TestCategory("Calculations")]
        [DataRow(2.891, 1.982, 4.599, 26.352095238)]
        [DataRow(7.382, 9.834, 3.941, 286.095271308)]
        [DataRow(6.486, 9.563, 9.564, 593.213010552)]
        public void Volume_Calculation_Test(double a, double b, double c, double expectedDouble)
        {
            var p = new Pudelko(a, b, c, unit: UnitOfMeasure.meter);
            Assert.AreEqual(expectedDouble, p.Objetosc);
        }

        [DataTestMethod, TestCategory("Calculations")]
        [DataRow(8.564, 6.846, 5.646, 291.268008)]
        [DataRow(3.748, 5.634, 8.943, 210.038916)]
        [DataRow(6.358, 9.685, 5.648, 304.376188)]
        public void Surface_Calculation_Test(double a, double b, double c, double expectedDouble)
        {
            var p = new Pudelko(a, b, c, unit: UnitOfMeasure.meter);
            Assert.AreEqual(expectedDouble, p.Pole);
        }
        #endregion

        #region Equals ===========================================
        [TestMethod, TestCategory("Equals")]
        [DataRow(1, 2, 3.5, UnitOfMeasure.meter, 1, 2, 3.5, UnitOfMeasure.meter)]
        [DataRow(1, 2, 3.5, UnitOfMeasure.meter, 100, 200, 350, UnitOfMeasure.centimeter)]
        [DataRow(1, 2, 3.5, UnitOfMeasure.meter, 1000, 2000, 3500, UnitOfMeasure.milimeter)]
        public void Equals_Same_Tests(double a1, double b1, double c1, UnitOfMeasure unit1, double a2, double b2, double c2, UnitOfMeasure unit2)
        {
            Assert.AreEqual(new Pudelko(a1, b1, c1, unit1), new Pudelko(a2, b2, c2, unit2));
        }

        [TestMethod, TestCategory("Equals")]
        [DataRow(1, 2, 3.5, UnitOfMeasure.meter, 9, 2, 3.5, UnitOfMeasure.meter)]
        [DataRow(1, 2, 3.5, UnitOfMeasure.meter, 1, 2, 3.5, UnitOfMeasure.centimeter)]
        [DataRow(1, 2, 3.5, UnitOfMeasure.meter, 6546, 216, 8674, UnitOfMeasure.milimeter)]
        public void Not_Equals_Tests(double a1, double b1, double c1, UnitOfMeasure unit1, double a2, double b2, double c2, UnitOfMeasure unit2)
        {
            Assert.AreNotEqual(new Pudelko(a1, b1, c1, unit1), new Pudelko(a2, b2, c2, unit2));
        }

        [TestMethod, TestCategory("Equals")]
        public void Not_Equals_Null_Tests()
        {
            Assert.AreNotEqual(new Pudelko(1, 1, 1), null);
            Assert.AreNotEqual(new Pudelko(0.1, 0.1, 0.1), null);
            Assert.AreNotEqual(new Pudelko(), null);
        }
        #endregion
